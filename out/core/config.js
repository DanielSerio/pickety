...
function validateBoundaryRules(rules, errors) {
    if (rules === undefined) {
        errors.push({
    ...
    bObj.rules.forEach((rule, index) => {
        ...
        validatedRules.push(r);
    });
    return { severity, rules: validatedRules };
}
function validateBoundaryDiagrams(val, errors) {
    if (val !== undefined) {
...
function validateHealthConfig(health, errors) {
    if (health === undefined) {
        return undefined;
    }
